    ...
    <div className="flex flex-col w-full bg-section-bg pb-24">
      ...
      <section className="bg-gradient-to-r from-dark-blue to-primary-blue text-white py-16">
        <div className="max-w-7xl mx-auto px-6 text-center flex flex-col gap-4">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Used Car Loan</h1>
          <div className="flex justify-center items-center gap-2 text-xs md:text-sm font-semibold text-white/70">
            ...
            <span>/</span>
            <span className="text-white">Used Car Loan</span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto w-full px-6 mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            >
              ...
              <p className="text-text-gray font-medium leading-relaxed text-sm md:text-base">
                Secure a certified used car with EAZYKREDIT's tailored pre-owned vehicle loan programs. We guide you through valuation checks, RC transfer paperwork, and multi-bank comparison to get fast approval at competitive rates. Rates starting from 11.50% p.a.
              </p>

              <h3 className="font-extrabold text-xl text-dark-blue mt-4">Benefits & Features</h3>
              <ul className="flex flex-col gap-3">
                {[
                  { title: "High Value Financing", desc: "Get funding up to 80% to 85% of the vehicle's evaluated valuation." },
                  { title: "Flexible Interest Programs", desc: "Interest rate packages starting from 11.50% p.a." },
                  { title: "Convenient Tenures", desc: "Structured monthly repayments spanning up to 5 years." },
                  { title: "RC Transfer Coordination", desc: "Dedicated team coordinates the title transfer at local RTOs." },
                  { title: "Quick Valuation Matrix", desc: "Fast vehicle health checks and value estimations by bank engineers." }
                ].map((feat, i) => (
                ...
                <table className="w-full text-xs md:text-sm text-left border-collapse">
                  <thead>
                    <tr className="bg-section-bg text-dark-blue font-bold border-b border-border-color">
                      ...
                      <th className="p-3">Salaried Profiles</th>
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-border-color">
                      ...
                      <td className="p-3 text-text-gray">₹22,000 / Month</td>
                      <td className="p-3 text-text-gray">₹3.0 Lakhs ITR / Year</td>
                    </tr>
                    <tr className="border-b border-border-color">
                      <td className="p-3 font-bold text-text-dark">Vehicle Age Limit</td>
                      <td className="p-3 text-text-gray">Max 8 years old at loan end</td>
                      <td className="p-3 text-text-gray">Max 8 years old at loan end</td>
                    </tr>
                    <tr>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border border-border-color p-5 rounded-lg flex flex-col gap-3 bg-section-bg/30">
                  ...
                  <ul className="flex flex-col gap-2 text-xs text-text-gray leading-relaxed">
                    ...
                    <li className="flex gap-2">✓ Original RC Copy & Insurance</li>
                    <li className="flex gap-2">✓ Car Valuation Certificate</li>
                  </ul>
                </div>
                ...
                <div className="border border-border-color p-5 rounded-lg flex flex-col gap-3 bg-section-bg/30">
                  ...
                  <ul className="flex flex-col gap-2 text-xs text-text-gray leading-relaxed">
                    ...
                    <li className="flex gap-2">✓ 2 Years ITR Calculations</li>
                    <li className="flex gap-2">✓ Original RC Copy & Insurance</li>
                    <li className="flex gap-2">✓ Car Valuation Certificate</li>
                  </ul>
                </div>
              ...
              {/* Local FAQs */}
              <h3 className="font-extrabold text-xl text-dark-blue mt-6">Used Car Loan FAQs</h3>
              <div className="flex flex-col gap-3">
                {[
                  {
                    q: "How does the bank determine the value of a used car?",
                    a: "The lender will appoint an authorized surveyor/valuation engineer to physically inspect the car's engine health, model year, manufacturing date, and odometer. The loan amount is calculated on their final valuation assessment, not the dealer's selling price."
                  },
                  {
                    q: "What is the maximum allowed age of a pre-owned car to secure a loan?",
                    a: "Lenders prefer cars that are less than 5 to 6 years old at the time of application, and the car's age should not exceed 8 to 10 years by the time the loan tenure completes."
                  }
                ].map((faq, idx) => (
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 sticky top-28">
            <QuickApplyForm loanType="Used Car Loan" />
              ...
              <div className="flex flex-col gap-3">
                <Link href="/loans/car-loan" className="flex items-center justify-between p-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/5 transition-all">
                  <div className="flex flex-col">
                    <span className="font-bold text-sm">New Car Loan</span>
